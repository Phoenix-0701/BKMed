  ...
  const handleAvatarChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error("Lỗi lấy URL upload: " + errorText);
      }
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-xs">
      <div className="relative w-full max-w-2xl rounded-2xl bg-white shadow-2xl dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800 overflow-hidden">
        ...
        <form onSubmit={handleSubmit}>
              ...
              <div className="flex-1 w-full flex flex-col gap-4">
                ...
                <div className="mt-3">
                  ...
                  <input
                    type="text"
                    required
                    placeholder="Mật khẩu tạo cho bác sĩ (VD: Doctor123@)"
          ...
          {/* Footer Buttons */}
          <div className="flex items-center justify-end gap-4 px-6 py-4 dark:border-zinc-800">
            <button
              type="button"
              onClick={onClose}
